...
export default function GameComplete() {
  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-gradient-to-b from-amber-950 via-purple-950 to-purple-950">
      <div className="min-h-full flex flex-col items-center justify-center p-6 space-y-5 text-center">
